...
#./plot1DSignal.sh PF_charge_piezo 10 Time 1E-8 s "0 22" 4f2 A  3E-10 "A" "-1 1" 1f0.5
./plot1DSignal.sh PF.S21.BXZ.semd 10 Time 1E-8 s "0 22" 4f2 A  1E-10 "A" "-1 1" 1f0.5
