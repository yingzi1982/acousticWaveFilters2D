...
./plot1DSignal.sh charge 10 Time 1E-8 s "0 10" 2f1 Charge  2E-12 "C" "-1 1" 1f0.5
exit
...
./plot1DSignal.sh admittance_real 1 Freq 1E9 Hz "0.5 1.5" 1f0.5 Amp 1E0 "" "-1 1" ''
./plot1DSignal.sh admittance_imag 1 Freq 1E9 Hz "0.5 1.5" 1f0.5 Amp 1E0 "" "-1 1" ''
