...
#--------------------------------------------------
if true; then
./plot2DField.sh potential S   '-CGMT_seis.cpt -Iz'  1E0  V        $dx X 1E-6 m $xtick $dz Z 1E-6 m $ytick
./plot2DField.sh electric  V1  '-CGMT_hot.cpt -Iz'   1E6  V/m      $dx X 1E-6 m $xtick $dz Z 1E-6 m $ytick
./plot2DField.sh electric  V2  '-CGMT_seis.cpt -Iz'  1E6  V/m      $dx X 1E-6 m $xtick $dz Z 1E-6 m $ytick
./plot2DField.sh bodyforce V1  '-CGMT_hot.cpt -Iz'   1E13 $bodyforce_unit $dx X 1E-6 m $xtick $dz Z 1E-6 m $ytick
./plot2DField.sh bodyforce V2  '-CGMT_seis.cpt -Iz'  1E13 $bodyforce_unit $dx X 1E-6 m $xtick $dz Z 1E-6 m $ytick
fi
#--------------------------------------------------
if false; then
for i in $(seq 1 35)
...
./plot2DField.sh $snapshot V2  '-CGMT_seis.cpt -Iz'  1E-11 m $dx2 X 1E-6 m $xtick $dz2 Z 1E-6 m $ytick
rm $snapshot_file
done
