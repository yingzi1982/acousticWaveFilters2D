...
./plot1DSignal.sh charge 10 Time 1E-8 s "0 5" 5f2.5 Charge  2E-11 "C" "-5 5" 1f.5
...
./plot1DSignal.sh admittance_real 1 Freq 1E9 Hz "0.6 1.0" 0.2f0.1 Amp 1E-1 "" "-100 100" ''
./plot1DSignal.sh admittance_imag 1 Freq 1E9 Hz "0.8 0.9" 0.01f0.005 Amp 1E-1 "" "-100 100" ''
