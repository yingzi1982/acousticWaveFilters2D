...
./plot1DSignal.sh PF_charge_piezo 10 Time 1E-8 s "0 10" 4f2 A  2E-11 "A" "-1 1" 1f0.5
...
./plot1DSignal.sh admittance_real 1 Freq 1E9 Hz "0 3" 1f0.5 Amp 1E0 "" "-0.4 0.4" ''
./plot1DSignal.sh admittance_imag 1 Freq 1E9 Hz "0 3" 1f0.5 Amp 1E0 "" "-0.4 0.4" ''
