...
./plot1DSignal.sh charge 10 Time 1E-8 s "0 15" 5f2.5 Charge  2E-11 "C" "-50 50" 10f5
...
./plot1DSignal.sh admittance_real 1 Freq 1E9 Hz "0.5 0.8" .1f0.05 Amp 1E-1 "" "-900 900" ''
./plot1DSignal.sh admittance_imag 1 Freq 1E9 Hz "0.5 0.8" .1f0.05 Amp 1E-1 "" "-900 900" ''
