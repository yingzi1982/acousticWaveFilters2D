...
./plot1DSignal2.sh admittance_abs 1 Freq 1E9 Hz "0.6 1.0" 0.2f0.1 Abs 1E0 "" "-45 0" 20f10
fi
...
./plot1DSignal.sh charge 10 Time 1E-8 s "0 4" 2f1 Charge  20E-11 "C" "-5 5" 1f.5
