...
./plot1DSignal.sh  charge 10 Time 1E-9 s "0 20" 20f10 Current 1E-11 "C" "-1 1" 1f0.5
./plot1DSignal.sh current 10 Time 1E-9 s "0 20" 20f10 Charge  1E0 "" "-.04 .04" 0.04f0.02
